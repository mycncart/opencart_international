...
$_['text_edit']                    = 'Editar relatório de atividades do cliente';
$_['text_success']                 = 'Sucesso: você modificou o relatório de atividades do cliente!';
$_['text_filter']                  = 'Filtro';
$_['text_activity_register']       = '<a href="customer_id=%d">%s</a> registrou uma nova conta.';
$_['text_activity_edit']           = '<a href="customer_id=%d">%s</a> atualizou os detalhes da conta.';
$_['text_activity_password']       = '<a href="customer_id=%d">%s</a> atualizou a senha da conta.';
$_['text_activity_reset']          = '<a href="customer_id=%d">%s</a> solicitou a recuperação de senha.';
...
$_['text_activity_affiliate_add']  = '<a href="affiliate_id=%d">%s</a> cadastrou uma conta.';
$_['text_activity_affiliate_edit'] = '<a href="affiliate_id=%d">%s</a> atualizou os detalhes da conta.';
$_['text_activity_transaction']    = '<a href="customer_id=%d">%s</a> comissão recebida de um novo <a href="order_id=%d">ordem</a>.';
...
// Error
$_['error_permission']             = 'Aviso: você não tem permissão para modificar o relatório de atividades do cliente!';