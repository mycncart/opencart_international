...
// Text
$_['text_uploaded']    = '成功：ファイルをアップロードしました!';
$_['text_directory']   = '成功：ディレクトリを作成しました!';
$_['text_delete']      = '成功：ファイルまたはディレクトリを削除しました!';

// Entry
$_['entry_search']     = '検索中..';
$_['entry_folder']     = 'フォルダ名';

// Error
$_['error_permission'] = '警告: 権限がありません!';
$_['error_filename']   = '警告: ファイル名は、3文字以上255文字以下で入力してください!';
