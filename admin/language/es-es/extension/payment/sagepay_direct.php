...
$_['text_success']			  = 'Operación Exitosa: Detalles de Cuenta SagePay.';
...
$_['entry_cron_job_url']	  = 'URl del Cron Job\'s';
$_['entry_last_cron_job_run'] = 'Ultima Corrida del Cron Job\'s:';
...
$_['help_transaction']		  = 'El Método de Transacción debe ser Configurado para permitir Suscripción a los Pagos.';
$_['help_cron_job_token']	  = 'De mayor longitud y difícil de adivinar.';
...
// Error
$_['error_permission']		  = 'Error: Sin permiso para modificar el Método de Pago SagePay.';
$_['error_vendor']			  = 'Vendedor ID Obligatorio.';