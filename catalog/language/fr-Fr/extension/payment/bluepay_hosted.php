<?php
// Text
$_['text_title']				='Carte de crédit / débit (BluePay)';
$_['text_credit_card']			='Détails de la carte';
$_['text_description']			='Articles sur %s Numéro de commande: %s';
...
$_['entry_card_save']			='Rappelez les détails de la carte';
